 ...
 * 
 * TODO - redstone under the track?  if you click redstone on a straight rail, it runs a wire underneath the rail?
 * 
 * idea - take passengers from x to y, randomly (ala UG?)
 * or take fuel and things around like ttd?
 * 
 */
...
var TrainGame = function(div,div2){
    ...
    this.tools=["track","power","wire","repeater","block","delete","cart","logic"];
